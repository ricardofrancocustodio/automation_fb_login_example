...
public class BasePage {
    ...
    public String getTextFromInput(By by){
        return driver.findElement(By.id(String.valueOf(by))).getAttribute("value");
    }

    public String getHyperlink(By by){
        return driver.findElement(By.id(String.valueOf(by))).getAttribute("href");
    }

    public boolean buttonIsEnabled(By by){
        return driver.findElement(by).isEnabled();
    }

    public boolean linkIsEnabled(String locator){
